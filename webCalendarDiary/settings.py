"""
Django settings for webCalendarDiary project.
...
SECRET_KEY = '%yav#rgo2ifr)-)44to+qeg77_p-$lcz84qyn(043l#iplp89m'
...
ROOT_URLCONF = 'webCalendarDiary.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [
            os.path.join(BASE_DIR, 'templates') # 홈뷰홈뷰
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'webCalendarDiary.wsgi.application'
